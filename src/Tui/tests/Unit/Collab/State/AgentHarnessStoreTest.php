...
namespace Phalanx\Tui\Tests\Unit\Collab\State;
...
use Phalanx\Tui\Collab\State\EffectSlice;
use Phalanx\Tui\Collab\State\InputComposerSlice;
use Phalanx\Tui\Collab\State\LoopSlice;
use Phalanx\Tui\Collab\State\MessageTimelineSlice;
use Phalanx\Tui\Collab\State\NotificationSlice;
...
use Phalanx\Tui\Collab\State\WorkspaceViewSlice;
...
final class AgentHarnessStoreTest extends TestCase
{
    ...
    public function tuiSignalScannerCanSubscribeToAgentHarnessStoreReads(): void
    {
        ...
        $component = new class ($store) implements Component {
            ...
            {
                return \Phalanx\Tui\Tui\Kit\text($this->store->loop->stage->value);
            }
        };
