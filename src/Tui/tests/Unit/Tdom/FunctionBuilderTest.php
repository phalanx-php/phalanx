...
namespace Phalanx\Tui\Tests\Unit\Tdom;
...
use function Phalanx\Tui\Kit\input;
...
use function Phalanx\Tui\Kit\spinner;
...
final class FunctionBuilderTest extends TestCase
{
    ...
    public function mountRejectsPositionalProps(): void
    {
        ...
        mount(FunctionBuilderComponent::class, 'WebSocket');
    }
}
