...
use Phalanx\Tui\Runtime\Boundaries\InletQueue;
use Phalanx\Tui\Runtime\Boundaries\InputPromptSubmitter;
use Phalanx\Tui\Runtime\Boundaries\Outlet;
use Phalanx\Tui\Runtime\Boundaries\OutletReactor;
use Phalanx\Tui\Runtime\Boundaries\PromptInletMapper;
...
final class BoundaryRuntimeTest extends TestCase
{
    ...
    #[Test]
    public function tuiRuntimeUsesTheCurrentTaskScopeOnEachTick(): void
    {
