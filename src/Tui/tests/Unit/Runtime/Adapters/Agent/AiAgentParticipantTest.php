...
namespace Phalanx\Tui\Tests\Unit\Runtime\Adapters\Agent;
...
use Phalanx\Tui\Runtime\Adapters\Agent\AgentRunner;
use Phalanx\Tui\Runtime\Adapters\Agent\AiAgentParticipant;
...
use Phalanx\Tui\Runtime\Plans\WorkResultStatus;
...
final class AiAgentParticipantTest extends TestCase
{
    ...
    public function workItemPromptBecomesTheInitialAgentUserMessage(): void
    {
        ...
        $result = $participant(new WorkContext($this->createStub(TaskScope::class)), $item);
    ...
    public function cancelledAgentResultPropagatesCancellation(): void
    {
        ...
        $participant(new WorkContext($this->createStub(TaskScope::class)), $item);
    }
