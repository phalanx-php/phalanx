...
final class Builder
{
    ...
    {
        if ($seconds <= 0.0) {
            throw new InvalidArgumentException('TUI runtime tick interval must be greater than zero.');
        }
    ...
    {
        return $this->primary ?? throw new InvalidArgumentException('A primary Runtime participant is required.');
    }
