...
namespace Phalanx\Tui\Tui\Apps;
...
use Phalanx\Tui\Tui\Core\HandlesKeySequences;
use Phalanx\Tui\Tui\Core\HasActivityPulse;
use Phalanx\Tui\Tui\Core\HasFocusables;
use Phalanx\Tui\Tui\Core\HasKeySequenceState;
use Phalanx\Tui\Tui\Core\HasOverlayFrame;
use Phalanx\Tui\Tui\Core\HasStatusBar;
use Phalanx\Tui\Tui\Core\HasWorkspaceInputModes;
use Phalanx\Tui\Tui\Core\MountedComponent;
use Phalanx\Tui\Tui\Core\MountSystem;
use Phalanx\Tui\Tui\Core\PreparesWorkspaceDraw;
use Phalanx\Tui\Tui\Core\ProvidesMountServices;
use Phalanx\Tui\Tui\Core\RefreshesPeriodically;
...
use Phalanx\Tui\Tui\Drawing\Region;
...
use Phalanx\Tui\Tui\Inputs\FocusManager;
use Phalanx\Tui\Tui\Inputs\InputEvent;
use Phalanx\Tui\Tui\Inputs\InputMode;
use Phalanx\Tui\Tui\Inputs\InputModeSlice;
use Phalanx\Tui\Tui\Inputs\KeyEvent;
use Phalanx\Tui\Tui\Inputs\ModeDispatcher;
use Phalanx\Tui\Tui\Inputs\NormalModeHandler;
use Phalanx\Tui\Tui\Kit\ScreenLayout;
                ...
                if ($binding !== null) {
                    ...
                    if ($action !== null) {
                        ...
                        if ($action->isToggle() && $action->target !== null) {
                            /** @var class-string<\Phalanx\Tui\Tui\Core\Component> $target */
                            $target = $action->target;
