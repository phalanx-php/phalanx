...
use Phalanx\Tui\Core\HasOverlayFrame;
use Phalanx\Tui\Core\HasStatusBar;
use Phalanx\Tui\Core\HasWorkspaceInputModes;
use Phalanx\Tui\Core\MountedComponent;
use Phalanx\Tui\Core\MountSystem;
use Phalanx\Tui\Core\PreparesWorkspaceDraw;
use Phalanx\Tui\Core\ProvidesMountServices;
use Phalanx\Tui\Core\RefreshesPeriodically;
use Phalanx\Tui\Core\RenderContext;
use Phalanx\Tui\Core\RenderEnvironment;
use Phalanx\Tui\Core\Screen;
use Phalanx\Tui\Core\ScreenContext;
use Phalanx\Tui\Drawing\Buffer;
use Phalanx\Tui\Drawing\Rect;
use Phalanx\Tui\Drawing\Region;
                ...
                if ($binding !== null) {
                    ...
                    if ($action !== null) {
                        ...
                        if ($action->isToggle() && $action->target !== null) {
                            /** @var class-string<\Phalanx\Tui\Core\Component> $target */
                            $target = $action->target;
