...
final class AgentHarnessBuilder
{
    ...
    /** @var list<ServiceBundle|Closure(TuiApp): ServiceBundle> */
    ...
    /** @param ServiceBundle|Closure(TuiApp): ServiceBundle ...$providers */
    ...
    /** @return class-string<\Phalanx\Tui\Tui\Reactive\Store>|null */
    ...
    /** @return list<ServiceBundle|Closure(TuiApp): ServiceBundle> */
    ...
    public function resolvedProviders(TuiApp $app): array
    {
        $primary = $this->requirePrimary();

        return [
            new TuiServiceBundle($app),
