...
final class ChannelTest extends PhalanxTestCase
{
    ...
    public function emitRejectsBorrowedValues(): void
    {
        ...
        $this->expectExceptionMessage('Borrowed values cannot cross Stream channel boundaries');
    ...
    #[Test]
    public function emitRejectsBorrowedValuesInsideTuplePayloads(): void
    {
        $this->expectException(\LogicException::class);
        $this->expectExceptionMessage('Borrowed values cannot cross Stream channel boundaries');
