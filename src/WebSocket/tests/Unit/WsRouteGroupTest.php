...
final class WsRouteGroupTest extends TestCase
{
    ...
    public function websocket_routes_match_against_typed_request_scope_and_expose_params(): void
    {
        ...
        $resource = HttpRequestResource::open($app->runtime(), $request, $token, ownerScopeId: $scope->scopeId);
        $scope->bindScopedInstance(HttpRequestResource::class, $resource, inherit: true);
        $scope->bindScopedInstance(HttpRequestDiagnostics::class, new HttpRequestDiagnostics(), inherit: true);
