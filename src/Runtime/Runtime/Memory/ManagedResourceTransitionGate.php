...
final readonly class ManagedResourceTransitionGate
{
    ...
    public function open(
        ...
        try {
            ...
            $this->counters->tryIncr("runtime.resources.{$type}.opened");
            $event = $this->events->record(
                RuntimeEventSid::ResourceOpened,
                resourceId: $id,
                resourceType: $type,
    ...
    public function transition(
        ...
        try {
            ...
            if ($from->isTerminal()) {
                if ($from !== $to) {
                    $event = $this->events->record(
                        RuntimeEventSid::ResourceLateTransition,
                        resourceId: $id,
                        resourceType: $type,
            ...
            $this->counters->tryIncr("runtime.resources.{$type}.{$to->value}");
