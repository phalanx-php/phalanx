...
final class TestApp
{
    ...
    /**
     * Lenses Runtime ships unconditionally. Always available on every TestApp
     * because Runtime itself is always present; no bundle declares them.
     *
    ...
    public static function boot(array $context = [], ServiceBundle ...$bundles): self
    {
        ...
        $instance->registerRuntimeNativeLenses();
     ...
     * reads HttpApplication, AgentLens reads ProviderConfig). Bundle-internal
