 ...
 *
 * The Symfony process object stays behind this handle so Runtime can enforce
...
final class StreamingProcessHandle
{
    ...
    public function close(string $reason = 'manual'): void
    {
        ...
        try {
            $this->adapter->close();
            $this->recordEvent(RuntimeEventSid::ProcessExited, $reason);
        } finally {
    ...
    public function stop(float $gracefulTimeout = 1.0, float $forceTimeout = 0.0): void
    {
        ...
        try {
            ...
            $this->recordEvent(RuntimeEventSid::ProcessStopped, 'SIGTERM');
        } finally {
            $this->releaseResource();
        }
    }
    ...
    public function kill(): void
    {
        ...
        try {
            ...
            $this->recordEvent(RuntimeEventSid::ProcessKilled, 'SIGKILL');
        } finally {
            $this->releaseResource();
        }
    }
    ...
    private function recordEvent(RuntimeEventSid $eventId, string $data): void
    {
