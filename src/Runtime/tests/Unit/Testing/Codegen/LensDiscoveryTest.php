...
{
    public function testDiscoversRuntimeNativeLensesWithNoBundles(): void
    {
    ...
    public function testFactoryClassIsResolvedFromAttribute(): void
    {
        ...
        self::assertSame(\Phalanx\Runtime\Tests\Fixtures\Testing\FixtureLensFactory::class, $fixture->factoryClass);
    }
}
