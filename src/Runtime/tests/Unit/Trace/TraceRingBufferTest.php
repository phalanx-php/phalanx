...
namespace Phalanx\Runtime\Tests\Unit\Trace;
...
final class TraceRingBufferTest extends TestCase
{
    ...
    public function testEmptyTraceDoesNotPreallocateRingSlots(): void
    {
        $slots = new \ReflectionProperty(Trace::class, 'slots');

        self::assertSame([], $slots->getValue(new Trace()));
    }
    ...
    public function testLogicalSlotIsReplacedAfterWrap(): void
    {
        $trace = new Trace();
        $ringSize = self::ringSize();
