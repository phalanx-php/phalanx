...
namespace Phalanx\Runtime\Tests\Unit\Service;
...
final class FactoryDependencyResolutionTest extends TestCase
{
    ...
    {
        $result = Application::starting(['FACTORY_VALUE' => 'sparta'])
...
final class AutoResolvedFactoryBundle extends ServiceBundle
{
    ...
    {
        $services->singleton(AutoResolvedConfig::class)
            ->factory(static fn(): AutoResolvedConfig => new AutoResolvedConfig($context->string('FACTORY_VALUE')));
