...
/**
 * Runtime-managed accessor over Swoole\Server::stats().
 *
 ...
 * typed snapshot so callers (Http connection registries, admin endpoints,
 * the PressureMonitor) can ask Runtime for a server-wide read without
 * touching Swoole APIs directly.
 *
 * Http is the typical injector: it constructs the ServerStats with the
