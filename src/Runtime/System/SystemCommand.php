...
/**
 * Runtime-managed external command primitive.
 *
 ...
 * and downstream consumers (Network PingHost, Ssh SSH transport, Worker worker
 * spawn diagnostics, DevServer managed processes) share one canonical exec path.
 *
 * Usage:
 *
