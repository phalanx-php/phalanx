...
final class BuildConfig implements Config
{
    ...
    public function validate(ValidationContext $context): array
    {
        ...
        $validProfiles = array_map(static fn(BuildProfile $p) => $p->value, BuildProfile::cases());
        ...
        if (!in_array($this->defaultProfile, $validProfiles, strict: true)) {
            $valid = implode(', ', $validProfiles);
            $issues[] = new Issue(
                IssueLevel::Error,
