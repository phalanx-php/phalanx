...
use Phalanx\Stoa\Tests\Fixtures\Routes\InputCapturingValidator;
use Phalanx\Stoa\Tests\Fixtures\Routes\RequireApiVersionHandler;
use Phalanx\Stoa\Tests\Fixtures\Routes\ValidatedHandler;
use Phalanx\Stoa\Tests\Fixtures\Routes\ValidatedInputHandler;
...
final class CapabilityWiringTest extends TestCase
{
    ...
    public function has_validators_receives_hydrated_dto_when_handler_has_input_param(): void
    {
        ...
        $this->assertInstanceOf(\Phalanx\Stoa\Tests\Fixtures\Routes\SimpleInputDto::class, InputCapturingValidator::$capturedInput);
