    ...
    public function testReportsRawProcessManagement(): void
    {
        $this->analyse(
            ...
            [
                ...
                ['Subprocesses must be Aegis-managed resources; use Phalanx\System\StreamingProcess instead of Swoole\Process construction in package code.', 24],
                ['Subprocesses must be Aegis-managed resources; use Phalanx\System\StreamingProcess instead of Swoole\Process\Pool construction in package code.', 26],
