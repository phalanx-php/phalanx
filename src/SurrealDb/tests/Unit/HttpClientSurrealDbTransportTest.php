...
use Phalanx\SurrealDb\HttpClientSurrealDbTransport;
use Phalanx\SurrealDb\SurrealDbConfig;
use Phalanx\SurrealDb\SurrealDbException;
use Phalanx\Testing\PhalanxTestCase;
use PHPUnit\Framework\Attributes\Test;

final class HttpClientSurrealDbTransportTest extends PhalanxTestCase
{
    #[Test]
    public function rpcUsesHttpClientWithSurrealDbHeadersAndJsonEnvelope(): void
    {
        ...
        $transport = new HttpClientSurrealDbTransport($http);
        $config = new SurrealDbConfig(
            namespace: 'olympus',
            database: 'pantheon',
    ...
    public function unauthenticatedRequestsDoNotSendAuthorizationHeader(): void
    {
        $http = new RecordingHttpClient([self::jsonResponse('{"id":1,"result":{"ok":true}}')]);
        $transport = new HttpClientSurrealDbTransport($http);
        $config = new SurrealDbConfig(namespace: 'olympus', database: 'pantheon');
    ...
    #[Test]
    public function rpcErrorEnvelopeThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([self::jsonResponse(
    ...
    #[Test]
    public function rpcResponseIdMismatchThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([self::jsonResponse(
            '{"id":2,"result":{"ok":true}}',
        )]));
    ...
    #[Test]
    public function malformedRpcEnvelopeThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([self::jsonResponse('{"id":1}')]));
        $config = new SurrealDbConfig(namespace: 'olympus', database: 'pantheon');
    ...
    #[Test]
    public function nonObjectRpcEnvelopeThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([self::jsonResponse('"ok"')]));
        $config = new SurrealDbConfig(namespace: 'olympus', database: 'pantheon');
    ...
    #[Test]
    public function listRpcEnvelopeThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([self::jsonResponse('[{"result":true}]')]));
        $config = new SurrealDbConfig(namespace: 'olympus', database: 'pantheon');
    ...
    #[Test]
    public function nonSuccessfulHttpResponseThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([new HttpResponse(
            status: 500,
    ...
    #[Test]
    public function invalidJsonResponseThrowsSurrealDbException(): void
    {
        $transport = new HttpClientSurrealDbTransport(new RecordingHttpClient([new HttpResponse(
            status: 200,
            reasonPhrase: 'OK',
