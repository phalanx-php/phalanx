...
final class SurrealDbConfigTest extends TestCase
{
    #[Test]
    public function contextProvidesExplicitDatabaseAndTransportSettings(): void
    {
        $config = SurrealDbConfig::fromContext(new AppContext([
    ...
    {
        $config = new SurrealDbConfig(namespace: 'olympus', database: 'pantheon', endpoint: 'https://surrealdb.test');
    ...
    {
        $base = new SurrealDbConfig(namespace: 'olympus', database: 'pantheon', token: 'token');
