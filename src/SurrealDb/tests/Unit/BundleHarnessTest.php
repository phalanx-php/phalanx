...
final class BundleHarnessTest extends TestCase
{
    #[Test]
    public function harnessIsNonEmpty(): void
    {
        $harness = \Phalanx\SurrealDb\Bundle::harness();
    ...
    #[Test]
    public function contextSchemaListsConfigKeys(): void
    {
        $schema = \Phalanx\SurrealDb\Bundle::contextSchema();
        ...
        self::assertStringContainsString(\Phalanx\SurrealDb\Bundle::class, $schema->render());
    }
    ...
    public function evaluationPassesWithFullConfigPresent(): void
    {
        ...
        $report = (new BootHarnessRunner())->run($context, [\Phalanx\SurrealDb\Bundle::class], vendorDir: null);
