...
use Phalanx\HttpClient\Wire\ResponseDecoder;
...
final class HttpResponseDecoderTest extends TestCase
{
    ...
    public function decodesContentLengthBody(): void
    {
        ...
        $response = \Phalanx\HttpClient\Wire\ResponseDecoder::decode($payload);
    ...
    public function rejectsResponseWithoutHeaderBoundary(): void
    {
        ...
        \Phalanx\HttpClient\Wire\ResponseDecoder::decode('GET / HTTP/1.1');
    }
    ...
    {
        $this->expectException(\Phalanx\HttpClient\Exception::class);
        \Phalanx\HttpClient\Wire\ResponseDecoder::decode("nonsense\r\n\r\n");
    }
    ...
    {
        $this->expectException(\Phalanx\HttpClient\Exception::class);
        \Phalanx\HttpClient\Wire\ResponseDecoder::decode("HTTP/1.1 200 OK\r\nbroken-header-no-colon\r\n\r\n");
    }
