...
use Phalanx\Agents\Mcp\JsonRpc\Notification;
use Phalanx\Agents\Mcp\JsonRpc\Request;
use Phalanx\Agents\Mcp\JsonRpc\Response;
use Phalanx\Agents\Mcp\McpConnection;
use Phalanx\Agents\Mcp\McpTool;
...
final class SseConnection implements McpConnection
{
    ...
    public function tools(TaskScope $scope): array
    {
        $initResponse = $this->sendRequest($scope, new Request($this->nextId(), 'initialize', [
            ...
            'capabilities' => [],
            'clientInfo' => ['name' => 'phalanx-agents', 'version' => '0.2'],
        ]));
