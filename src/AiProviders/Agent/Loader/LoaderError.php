 ...
 * carries {@see \Phalanx\AiProviders\Agent\Discovered} but does not implement
 * {@see \Phalanx\AiProviders\Agent}, has a non-trivial constructor, a manifest
...
final class LoaderError extends \RuntimeException
{
    ...
    {
        return new self(
            "Class '{$class}' carries #[Discovered] but does not implement Phalanx\\AiProviders\\Agent.",
        );
    }
