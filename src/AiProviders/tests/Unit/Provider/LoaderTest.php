...
use Phalanx\AiProviders\Provider\ValidationError;
...
final class LoaderTest extends TestCase
{
    ...
    public function missingWireTranslatorClassResolvesToNull(): void
    {
        ...
        $yaml = self::validYaml();
        $nonexistent = 'Phalanx\\\\AiProviders\\\\__NONEXISTENT_FOR_TEST__\\\\Provider';
    ...
    public function realWireTranslatorClassResolves(): void
    {
        ...
        self::assertSame(\Phalanx\AiProviders\Provider\Anthropic\Provider::class, $config->wireTranslator);
    }
...
YAML;
    ...
    public function fakeYamlRoundTrip(): void
    {
        ...
        self::assertSame(\Phalanx\AiProviders\Provider\Fake\Provider::class, $config->wireTranslator);
    ...
    {
        return __DIR__ . '/../../Fixtures/Provider/anthropic.ai-providers.yaml';
    }
