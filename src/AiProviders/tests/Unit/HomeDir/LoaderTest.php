...
use Phalanx\AiProviders\HomeDir\Loader;
use Phalanx\AiProviders\HomeDir\ValidationError;
...
final class LoaderTest extends TestCase
{
    ...
    public function validYamlFileLoadsAdapter(): void
    {
        ...
        self::assertSame(\Phalanx\AiProviders\HomeDir\ClaudeCode\HomeDir::class, $config->adapter);
    }
    ...
    public function fromStringParsesBundledYaml(): void
    {
        $yaml = <<<'YAML'
            ...
            roots:
              - "~/.gemini"
            adapter: "Phalanx\\AiProviders\\HomeDir\\GeminiCli\\HomeDir"
            YAML;
    ...
    public function nonExistentFileThrowsInvalidArgument(): void
    {
        ...
        Loader::fromFile('/does/not/exist/ai-providers.yaml');
    }
    ...
    {
        return dirname(__DIR__, 2) . '/Fixtures/HomeDir/claudecode.ai-providers.yaml';
    }
}
