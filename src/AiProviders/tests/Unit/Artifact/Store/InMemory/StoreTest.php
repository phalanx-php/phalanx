...
namespace Phalanx\AiProviders\Tests\Unit\Artifact\Store\InMemory;

use Phalanx\AiProviders\Artifact;
use Phalanx\AiProviders\Artifact\Kind as ArtifactKind;
use Phalanx\AiProviders\Artifact\Store\InMemory\Store;
...
final class StoreTest extends TestCase
{
    ...
    public function byActivityReturnsCollection(): void
    {
        ...
        self::assertInstanceOf(
            \Phalanx\AiProviders\Artifact\Collection::class,
