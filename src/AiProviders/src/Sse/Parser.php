...
namespace Phalanx\AiProviders\Sse;

/**
 * Stateful WHATWG SSE parser. Reusable across any ai-providers consumer of
 * Server-Sent Events.
 *
...
final class Parser
{
    ...
    private static function parseEvent(string $eventText): ?Event
    {
        ...
        // OpenAI SSE may put the event type in the JSON payload instead.
        if ($dataLines === []) {
            return null;
        }
