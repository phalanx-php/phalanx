 ...
 * true incremental streaming, use Transport\HttpClient\Transport (requires
 * phalanx-http-client). Sync exists as a Phalanx-independent fallback for testing
 * and short responses.
 *
...
final class Transport implements TransportContract
{
    ...
    public function stream(Request $request, Runtime $runtime): \Generator
    {
        ...
        try {
            ...
            if (!$ok) {
                // Translate curl aborts from runtime cancellation.
