...
use Phalanx\AiProviders\Cue\Usage\Delta as UsageDelta;
...
use Phalanx\AiProviders\Provider\SseStreamingCueMapper;
use Phalanx\AiProviders\Sse\Event;

/**
 * Stateful mapper that translates Anthropic SSE events into ai-providers
...
final class CueMapper implements SseStreamingCueMapper
{
    ...
    /**
     * Translate one Anthropic SSE event into zero or more Cues.
     *
