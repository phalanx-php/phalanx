 ...
 * ai-providers {@see Cue} instances.
 *
 ...
 * {@see \Phalanx\AiProviders\Sse\Parser} passes these through with an empty
...
final class ChatCueMapper implements SseStreamingCueMapper
{
    ...
    public function translate(Event $event): \Generator
    {
        ...
        // Usage-only final chunk; emit terminal cues after finish_reason.
