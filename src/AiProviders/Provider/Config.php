 ...
 * class-string.
 *
 * `wireTranslator` carries the class-string of the concrete {@see \Phalanx\AiProviders\Provider}
...
final class Config implements Canonicalizable
{
     ...
     * @param class-string<\Phalanx\AiProviders\Provider>|null $wireTranslator
