...
final class MountSystemTest extends TestCase
{
    ...
    {
        $dirty = new \Phalanx\Theatron\Tui\Reactive\DirtyBatch();
        $scanResult = \Phalanx\Theatron\Tui\Core\SignalScanner::scan($component, $dirty);
...
final class SimpleTestComponent implements Component
{
    ...
    {
        return \Phalanx\Theatron\Tui\Kit\text('simple');
    }
}
...
final class ParamTestComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text($this->label);
    }
}
...
final class SignalTestComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text((string) $this->count->get());
    }
}
...
final class BorrowingComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text((string) $this->input->get());
    }
}
...
final class MountableTestComponent implements Component, Mountable
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text('mountable');
    }
...
final class ServiceConsumerComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text($this->service->name());
    }
}
...
final class SignalHoldingComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text((string) $this->counter->get());
    }
}
...
final class SlotParentComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        ...
        return \Phalanx\Theatron\Tui\Kit\column(
            \Phalanx\Theatron\Tui\Kit\mount(SlotChildComponent::class, input: $this->model->childSignal),
        );
    }
}
...
final class LabelSlotParentComponent implements Component
{
    ...
    {
        return \Phalanx\Theatron\Tui\Kit\column(
            \Phalanx\Theatron\Tui\Kit\mount(LabelSlotChildComponent::class, label: (string) $this->model->label->get()),
        );
    }
}
...
final class ActivationSlotParentComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        ...
        return \Phalanx\Theatron\Tui\Kit\column(
            \Phalanx\Theatron\Tui\Kit\mount(
                $component,
...
final class FailingAfterReplacementSlotParentComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        $child = \Phalanx\Theatron\Tui\Kit\mount(LabelSlotChildComponent::class, label: (string) $this->model->label->get());

        if ($this->model->throw) {
            throw new \RuntimeException('parent failed after replacement');
        }

        return \Phalanx\Theatron\Tui\Kit\column($child);
    }
}
...
final class FailingAfterNestedChildRenderParentComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        $child = \Phalanx\Theatron\Tui\Kit\mount(NestedChildSlotComponent::class, label: 'nested', model: $this->model);
...
final class AmbientServiceSlotParentComponent implements Component
{
    ...
    {
        return \Phalanx\Theatron\Tui\Kit\column(
            \Phalanx\Theatron\Tui\Kit\mount(ServiceConsumerComponent::class),
        );
    }
}
...
final class NestedChildSlotComponent implements Component
{
    ...
    public function __invoke(RenderContext $ctx): Renderable
    {
        ...
        return \Phalanx\Theatron\Tui\Kit\column(
            \Phalanx\Theatron\Tui\Kit\text($this->label),
            \Phalanx\Theatron\Tui\Kit\mount(SlotChildComponent::class, input: $this->model->childSignal),
        );
    }
}
