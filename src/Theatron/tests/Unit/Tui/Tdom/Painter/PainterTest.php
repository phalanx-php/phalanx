...
namespace Phalanx\Theatron\Tests\Unit\Tui\Tdom\Painter;
...
use Phalanx\Theatron\Tui\Tdom\Element\ProgressElement;
use Phalanx\Theatron\Tui\Tdom\Element\RowElement;
use Phalanx\Theatron\Tui\Tdom\Element\ScrollElement;
use Phalanx\Theatron\Tui\Tdom\Element\SpinnerElement;
...
final class PainterTest extends TestCase
{
    ...
    public function paintCleanMountedComponentSkipsRerender(): void
    {
        ...
        $component = new class ($tracker) implements Component {
            ...
            public function __invoke(RenderContext $ctx): Renderable
            {
                ...
                return \Phalanx\Theatron\Tui\Kit\text('cached');
            }
        };
    ...
    public function paintMountedComponentWithNullLastResultIsNoOp(): void
    {
        $component = new class () implements Component {
            public function __invoke(RenderContext $ctx): Renderable
            {
                return \Phalanx\Theatron\Tui\Kit\text('never');
            }
        };
...
final class PainterMountChildComponent implements Component
{
    public function __invoke(RenderContext $ctx): Renderable
    {
        return \Phalanx\Theatron\Tui\Kit\text('Mounted');
    }
}
