...
return [
    ...
    'Dory' => [
        'package' => 'phalanx-php/dory',
        'description' => 'Native scripting environment for Phalanx with supervised execution, lazy module services, and fluent orchestration',
        'type' => 'library',
        'namespace' => 'Phalanx\\Dory\\',
        'smokeClass' => 'Phalanx\\Dory\\Dory',
        'testNamespace' => 'Phalanx\\Dory\\Tests\\',
        'requires' => [
            'php' => '^8.4',
            'phalanx-php/aegis' => '^0.6',
            'phalanx-php/archon' => '^0.6',
        ...
        'suggests' => [
            'phalanx-php/iris' => 'For HTTP client access via dory()->http',
            'phalanx-php/grammata' => 'For filesystem access via dory()->fs',
            'phalanx-php/styx' => 'For reactive stream primitives',
            'phalanx-php/hydra' => 'For worker process parallelism',
            'phalanx-php/dorybin' => 'For static binary compilation via SPC',
        ],
    ],
    'DoryBin' => [
        'package' => 'phalanx-php/dorybin',
        'description' => 'Static binary compiler for Phalanx using SPC (static-php-cli)',
        'type' => 'library',
        'namespace' => 'Phalanx\\DoryBin\\',
        'smokeClass' => 'Phalanx\\DoryBin\\DoryBin',
        'testNamespace' => 'Phalanx\\DoryBin\\Tests\\',
        'requires' => [
            'php' => '^8.4',
            'phalanx-php/aegis' => '^0.6',
            'phalanx-php/archon' => '^0.6',
