...
return [
    'Aegis' => [
        ...
        'bins' => ['bin/regenerate-accessors', 'bin/check-accessors-in-sync'],
    ...
    'Archon' => [
        ...
        'requires' => ['php' => '^8.4', 'phalanx-php/aegis' => '^0.6'],
    ...
    'Argos' => [
        ...
        'requires' => ['php' => '^8.4', 'ext-openswoole' => '*', 'phalanx-php/aegis' => '^0.6', 'mlocati/ip-lib' => '^1.22'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    ...
    'Cli' => [
        ...
        'requires' => ['php' => '^8.4', 'symfony/console' => '^7.4 || ^8.0', 'symfony/process' => '^7.4 || ^8.0'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => ['bin/phalanx'],
        'branchAlias' => '0.6.x-dev',
    ],
    'Eidolon' => [
        ...
        'requires' => ['php' => '^8.4', 'phalanx-php/aegis' => '^0.6', 'phalanx-php/stoa' => '^0.6', 'phalanx-php/styx' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'Enigma' => [
        ...
        'requires' => ['php' => '^8.4', 'phalanx-php/aegis' => '^0.6', 'phalanx-php/grammata' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'Grammata' => [
        ...
        'requires' => ['php' => '^8.4', 'phalanx-php/aegis' => '^0.6', 'phalanx-php/styx' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'Hermes' => [
        ...
        'requires' => ['php' => '^8.4', 'openswoole/core' => '^26.2', 'phalanx-php/aegis' => '^0.6', 'phalanx-php/stoa' => '^0.6', 'phalanx-php/styx' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    ...
    'Iris' => [
        ...
        'requires' => ['php' => '^8.4', 'openswoole/core' => '^26.2', 'phalanx-php/aegis' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'PHPStan' => [
        ...
        'requires' => ['php' => '^8.4', 'phpstan/phpstan' => '^2.0'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'Panoply' => [
        ...
        'requires' => ['php' => '^8.4', 'symfony/uid' => '^7.0 || ^8.0', 'symfony/yaml' => '^7.0 || ^8.0'],
        'devRequires' => [
            'openswoole/ide-helper' => '^26.2',
            'phalanx-php/aegis' => '^0.6',
            'phalanx-php/iris' => '^0.6',
    ...
    'Skopos' => [
        ...
        'requires' => ['php' => '^8.4', 'ext-openswoole' => '^26.0', 'phalanx-php/aegis' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => ['bin/skopos'],
        'branchAlias' => '0.6.x-dev',
    ],
    'Stoa' => [
        ...
        'requires' => ['php' => '^8.4', 'guzzlehttp/psr7' => '^2.0', 'nikic/fast-route' => '^2.0', 'openswoole/core' => '^26.2', 'phalanx-php/aegis' => '^0.6'],
        'devRequires' => ['phalanx-php/iris' => '^0.6', 'phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'Styx' => [
    ...
    'Surreal' => [
        ...
        'requires' => ['php' => '^8.4', 'phalanx-php/aegis' => '^0.6', 'phalanx-php/hermes' => '^0.6', 'phalanx-php/iris' => '^0.6'],
        'devRequires' => ['phpunit/phpunit' => '^13.0'],
        'bins' => [],
        'branchAlias' => '0.6.x-dev',
    ],
    'Theatron' => [
        ...
        'bins' => ['bin/theatron'],
        'branchAlias' => '0.6.x-dev',
        'autoloadFiles' => ['src/Ui/functions.php'],
    ],
];
