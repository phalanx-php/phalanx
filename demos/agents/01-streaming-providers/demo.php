 ...
 *
 * Boots Runtime with AgentsBundle, probes Ollama at localhost:11434 and
 ...
 *
 * Usage:
 *   php demos/agents/01-streaming-providers/demo.php
 *   php -d extension=swoole demos/agents/01-streaming-providers/demo.php
 *   OLLAMA_MODEL=mistral php -d extension=swoole demos/agents/01-streaming-providers/demo.php
 */
...
return static function (array $context): Closure {
        ...
        $inner = DemoReport::demo(
            ...
            static function (DemoReport $report): void {
                $report->cannotRun(
                    ...
                    'Run with: php -d extension=swoole demos/agents/01-streaming-providers/demo.php',
                );
            },
        );
    ...
    $bootClosure = DemoApp::boot(
        ...
        static function (DemoApp $app, DemoReport $report) use ($choice): void {
            ...
            // Run inside the Runtime task so Agents::run() can resolve its services.
            $result = $app->run(
            ...
            $report->record(
                'activity completed',
                $result->state === \Phalanx\Agents\Activity\State::Completed,
            );
