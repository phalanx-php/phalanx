 ...
 *
 * Boots Runtime with AgentsBundle pre-configured with the echo-server
 ...
 *
 * Usage:
 *   php -d extension=swoole demos/agents/03-mcp-stdio/demo.php
 */
...
return static function (array $context): Closure {
        ...
        $inner = DemoReport::demo(
            ...
            static function (DemoReport $report): void {
                $report->cannotRun(
                    ...
                    'Run with: php -d extension=swoole demos/agents/03-mcp-stdio/demo.php',
                );
            },
        );
    ...
    $serverScript = __DIR__ . '/../../..'
        . '/src/Agents/tests/Fixtures/mcp-echo-server.php';
    ...
    $bootClosure = DemoApp::boot(
        ...
        static function (DemoApp $app, DemoReport $report, AppContext $_ctx) use ($serverScript): void {
            ...
            /** @var \Phalanx\Agents\Effect\Outcome $outcome */
