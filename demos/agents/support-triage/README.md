...
# or via composer:
composer demo:agents:support-triage
```
...
```bash
composer demo:agents:serve:support-triage
# or with a specific Ollama model:
OLLAMA_MODEL=qwen2.5-coder:7b php -d extension=swoole demos/agents/support-triage/server.php
```
