...
return DemoApp::boot(
    'Worker Cancellation and Fail-Fast',
    static function (DemoApp $app, DemoReport $report): void {
        ...
        $timeoutMessage = $app->run(Task::named(
            'demo.worker.cancellation-fail-fast.timeout',
        ...
        $afterFailFast = $app->run(Task::named(
            'demo.worker.cancellation-fail-fast.after-fail-fast',
