...
# or via composer:
composer demo:agent:support-triage
```
...
```bash
composer demo:agent:serve:support-triage
# or with a specific Ollama model:
OLLAMA_MODEL=qwen2.5-coder:7b php -d extension=swoole demos/agent/support-triage/server.php
```
