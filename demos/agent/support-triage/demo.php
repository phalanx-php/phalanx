...
/**
 * Support Triage Agent — Agent v2 multi-tool activity.
 *
 ...
 *
 * Usage:
 *   php demos/agent/support-triage/demo.php
 *   php -d extension=swoole demos/agent/support-triage/demo.php
 *   OLLAMA_MODEL=mistral php -d extension=swoole demos/agent/support-triage/demo.php
 */
...
return static function (array $context): Closure {
        ...
        $inner = DemoReport::demo(
            ...
            static function (DemoReport $report): void {
                $report->cannotRun(
                    ...
                    'Run with: php -d extension=swoole demos/agent/support-triage/demo.php',
                );
            },
        );
    ...
    $bootClosure = DemoApp::boot(
        ...
        static function (DemoApp $app, DemoReport $report) use ($choice): void {
            ...
            $result = $app->run(
                static function (TaskScope $scope) use ($agent, $config, &$tokenCount, &$requestedCount, &$fullText): \Phalanx\Agent\Activity\Result {
