 ...
 *
 * Usage:
 *   php demos/agent/research-agent/demo.php
 *   php -d extension=swoole demos/agent/research-agent/demo.php
 *   OLLAMA_MODEL=mistral php -d extension=swoole demos/agent/research-agent/demo.php
 */
...
return static function (array $context): Closure {
        ...
        $inner = DemoReport::demo(
            ...
            static function (DemoReport $report): void {
                $report->cannotRun(
                    ...
                    'Run with: php -d extension=swoole demos/agent/research-agent/demo.php',
                );
            },
        );
        return ($inner)([]);
    ...
    $bootClosure = DemoApp::boot(
        ...
        static function (DemoApp $app, DemoReport $report) use ($choice): void {
            ...
            $result = $app->run(
                static function (TaskScope $scope) use ($agent, $config, &$tokenCount, &$fullText): \Phalanx\Agent\Activity\Result {
