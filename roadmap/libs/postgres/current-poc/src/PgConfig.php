...
final class PgConfig
{
    public function __construct(
        private(set) string $host = 'localhost',
        private(set) int $port = 5432,
        private(set) ?string $user = null,
        private(set) ?string $password = null,
        private(set) ?string $database = null,
        private(set) int $maxConnections = 10,
        private(set) int $idleTimeout = 60,
        private(set) ?string $applicationName = 'phalanx',
        private(set) ?string $sslMode = null,
    ) {}
