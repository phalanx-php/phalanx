...
final class Terminal
{
    ...
    /**
     * @dev-cleanup-ignore Boot-time terminal detection via subprocess.
     *   Runs once before any Aegis scope exists — same exception category
     *   as AnsiWriter's bounded fwrite retry.
     *
