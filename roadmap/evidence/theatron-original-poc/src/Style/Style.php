...
final class Style
{
    ...
    private(set) ?Color $foreground;
    private(set) ?Color $background;
    private(set) int $modifierBits;
    ...
    public function equals(self $other): bool
    {
        $fgEqual = ($this->foreground === null && $other->foreground === null)
            || ($this->foreground !== null && $other->foreground !== null && $this->foreground->equals($other->foreground));

        $bgEqual = ($this->background === null && $other->background === null)
            || ($this->background !== null && $other->background !== null && $this->background->equals($other->background));
