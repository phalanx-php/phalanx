...
final class V0AcceptanceGateTest extends TestCase
{
    ...
    public function gate15HomeDirAutoDetectReturnsPresentTools(): void
    {
        ...
        try {
            ...
            $homes[] = $fullHome = self::writeGate15Home('.claude', '.gemini', '.codex');
            $fullRegistry = HomeDirRegistry::autoDetect($fullHome);
            ...
            $homes[] = $partialHome = self::writeGate15Home('.claude');
            $partialRegistry = HomeDirRegistry::autoDetect($partialHome);
            ...
            $homes[] = $noneHome = self::writeGate15Home();
            $noneRegistry = HomeDirRegistry::autoDetect($noneHome);
