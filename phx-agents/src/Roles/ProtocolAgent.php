...
final class ProtocolAgent implements AgentDefinition
{
    public string $instructions {
        get => file_get_contents('/Users/jhavens/.obsidian/vaults/aimind/AIMind/35-multiagent/playbooks/daemon8-brainstorm-team/personas/protocol.persona.md');
    }
