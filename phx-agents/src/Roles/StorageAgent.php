...
final class StorageAgent implements AgentDefinition
{
    public string $instructions {
        get => file_get_contents('/Users/jhavens/.obsidian/vaults/aimind/AIMind/35-multiagent/playbooks/daemon8-brainstorm-team/personas/storage.persona.md');
    }
