...
final class HttpRequestEncoderTest extends TestCase
{
    ...
    {
        $encoded = HttpRequestEncoder::encode(StoaHttpRequest::get('http://example.com/path?q=1'));
    ...
    {
        $encoded = HttpRequestEncoder::encode(StoaHttpRequest::get('http://example.com:8443/'));
    ...
    {
        $encoded = HttpRequestEncoder::encode(StoaHttpRequest::post('http://example.com/', 'hello'));
    ...
    {
        $encoded = HttpRequestEncoder::encode(StoaHttpRequest::get('http://example.com/'), userAgent: 'TestAgent/1.0');
    ...
    public function userAgentNotOverriddenWhenProvided(): void
    {
        $encoded = HttpRequestEncoder::encode(
            new StoaHttpRequest('GET', 'http://example.com/', ['User-Agent' => ['Caller/2.0']]),
    ...
    {
        $encoded = HttpRequestEncoder::encode(StoaHttpRequest::get('https://example.com/'));
    ...
    public function rejectsUnsupportedScheme(): void
    {
        ...
        HttpRequestEncoder::encode(StoaHttpRequest::get('ftp://example.com/'));
    }
    ...
    {
        $this->expectException(HttpClientException::class);
        HttpRequestEncoder::encode(StoaHttpRequest::get('not a url'));
    }
}
