...
use Phalanx\Stoa\Http\Client\StoaHttpClientConfig;
use Phalanx\System\TlsOptions;
use PHPUnit\Framework\Attributes\Test;
use PHPUnit\Framework\TestCase;

final class StoaHttpClientConfigTest extends TestCase
{
    #[Test]
    public function defaultsAreSensibleForProduction(): void
    {
        $config = new StoaHttpClientConfig();
        ...
        self::assertSame('Phalanx-Stoa/0.2', $config->userAgent);
    ...
    public function tlsOptionsArePropagated(): void
    {
        ...
        $config = new StoaHttpClientConfig(tlsOptions: $tls);
