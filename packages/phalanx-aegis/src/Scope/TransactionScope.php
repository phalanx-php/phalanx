 ...
 *
 * A transaction may resolve services, read attributes, suspend through the
 * supervised call path, and register cleanup. It deliberately does not expose
 * TaskExecutor fan-out methods such as concurrent(), go(), or inWorker().
 */
