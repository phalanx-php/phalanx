...
use Phalanx\Ui\Signal\EventSignal;
use Phalanx\Ui\Signal\FlashSignal;
use Phalanx\Ui\Signal\InvalidateSignal;
use Phalanx\Ui\Signal\RedirectSignal;
use Phalanx\Ui\Signal\SignalCollector;
use Phalanx\Ui\Signal\TokenSignal;
