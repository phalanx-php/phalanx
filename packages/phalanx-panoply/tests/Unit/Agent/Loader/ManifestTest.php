...
use Phalanx\Panoply\Agent\Loader\Manifest;
...
final class ManifestTest extends TestCase
{
    ...
    public function unknownTopLevelKeyThrowsLoaderError(): void
    {
        $path = $this->writeTempManifest(
            "agents:\n  - class: Phalanx\\Panoply\\Tests\\Fixtures\\Agent\\Discovered\\HoplitesAgent\nfoo: bar\n"
        );
    ...
    {
        $path = tempnam(sys_get_temp_dir(), 'panoply_manifest_') . '.yaml';
