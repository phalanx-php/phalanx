...
namespace Phalanx\Panoply\Tests\Unit\Runtime\Aegis;

use Phalanx\Cancellation\CancellationToken;
use Phalanx\Panoply\Runtime\Aegis\Runtime;
...
final class RuntimeTest extends TestCase
{
    ...
    public function cancellationExceptionChainsAegisCancelled(): void
    {
        ...
        try {
            ...
            // The previous exception is the Aegis Cancelled thrown by the token.
