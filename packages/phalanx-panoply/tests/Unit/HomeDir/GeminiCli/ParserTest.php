...
use Phalanx\Panoply\HomeDir\GeminiCli\Source;
...
final class ParserTest extends TestCase
{
    ...
    {
        $tmpFile = tempnam(sys_get_temp_dir(), 'panoply_gc_') . '.jsonl';
        file_put_contents(
            $tmpFile,
    ...
    public function parserRejectsNonGeminiSource(): void
    {
        ...
        $parser = new Parser();
        $parser->parse(new \Phalanx\Panoply\HomeDir\ClaudeCode\Source('/some/path'));
    }
