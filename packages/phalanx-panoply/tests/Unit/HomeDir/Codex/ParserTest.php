...
use Phalanx\Panoply\HomeDir\Codex\Parser;
...
final class ParserTest extends TestCase
{
    ...
    public function parserThrowsForUnknownSourceType(): void
    {
        ...
        $parser = new Parser();
        $parser->parse(new \Phalanx\Panoply\HomeDir\ClaudeCode\Source('/path'));
    }
    ...
    public function timestampTieBreaksInFavourOfEarlierDeclaredSource(): void
    {
        ...
        $sessionsDir = sys_get_temp_dir() . '/panoply_tie_sess_' . uniqid();
