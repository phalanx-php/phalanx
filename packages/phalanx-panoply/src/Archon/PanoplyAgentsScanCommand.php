...
// Importing Phalanx\Scope and Phalanx\Task here is the documented second
// exception to the Phalanx-independence boundary — this file IS a first-party
// adapter that bridges the Archon CLI with the panoply Agent\Loader\Attribute
// scanner. Only these two imports are permitted; no other Phalanx\Aegis,
// Phalanx\Archon, Phalanx\Iris, or Phalanx\Grammata imports appear in this class.
