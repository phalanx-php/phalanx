...
| File | Purpose |
|------|---------|
| `ResearchAgent.php` | Main agent with retry policy and 60s timeout |
| `SummarizationAgent.php` | Sub-agent for document summarization |
| `DataAnalyst.php` | Sub-agent for spreadsheet analysis |
| `Tools/ExtractDocumentContent.php` | Spawns `SummarizationAgent` in a child scope |
| `Tools/QuerySpreadsheet.php` | Spawns `DataAnalyst` in a child scope |
| `Tools/CrossReference.php` | Cross-references data across document summaries |
