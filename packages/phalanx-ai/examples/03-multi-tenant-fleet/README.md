...
| File | Purpose |
|------|---------|
| `TenantAgentFactory.php` | Builds tenant-specific agents from database config |
| `TenantSupportAgent.php` | Runtime-configurable agent per tenant |
| `Tools/TransferToHuman.php` | Terminates agent loop, publishes escalation to dashboard |
| `Tools/TenantKbSearch.php` | Tenant-scoped knowledge base search |
