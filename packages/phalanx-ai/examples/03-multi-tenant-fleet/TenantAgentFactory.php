...
namespace Phalanx\Ai\Examples\MultiTenantFleet;

use Phalanx\Ai\AgentDefinition;
use Phalanx\Ai\Examples\MultiTenantFleet\Tools\TenantKbSearch;
use Phalanx\Ai\Examples\MultiTenantFleet\Tools\TransferToHuman;
...
final class TenantAgentFactory
{
    ...
    {
        /** @var array<string, class-string<\Phalanx\Ai\Tool\Tool>> $available */
        $available = [
            'knowledge_base' => TenantKbSearch::class,
            'transfer_to_human' => TransferToHuman::class,
        ];

        /** @var list<class-string<\Phalanx\Ai\Tool\Tool>> */
