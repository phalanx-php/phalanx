...
use Phalanx\Archon\Examples\InteractiveInput\InputBundle;
...
return static function (array $context): \Closure {
    ...
    return static function () use ($commands): int {
        ...
        $failed = !$runCase('register (non-TTY → defaults)', ['register'],                'Registered: demo@phalanx.local on free (terms=yes)', $commands) || false;
